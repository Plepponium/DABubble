...
import { authGuard, redirectIfNotLoggedIn } from './guards/auth.guard';
...
export const routes: Routes = [
    ...
    //     canActivateChild: [redirectIfNotLoggedIn],
    //     title: 'DABubble | Home' 
    // },
    { path: '', component: LoginComponent, title: 'DABubble | Login' },
    { path: 'main', component: MainPageComponent, canActivate: [authGuard], title: 'DABubble | Home' },
